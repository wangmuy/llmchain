...
interface BaseCallbackHandler {
    ...
    fun onToolStart(serialized: Map<String, Any>, inputStr: String, verbose: Boolean = false, args: Map<String, Any>? = null)
    fun onToolEnd(output: String, verbose: Boolean = false, args: Map<String, Any>? = null)
    fun onToolError(error: Throwable, verbose: Boolean = false, args: Map<String, Any>? = null)
